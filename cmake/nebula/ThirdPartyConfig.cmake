...
if(USE_TOPLINGDB)
    ...
    if(NOT "${EXTERNAL_TOPLINGDB_ROOT}" STREQUAL "" OR NOT "$ENV{EXTERNAL_TOPLINGDB_ROOT}" STREQUAL "")
        set(_topling_zip_boost_version_hpp "${TOPLINGDB_ROOT}/sideplugin/topling-zip/boost-include/boost/version.hpp")
        if(NOT EXISTS "${_topling_zip_boost_version_hpp}")
            message(FATAL_ERROR "External ToplingDB at ${TOPLINGDB_ROOT} is missing ${_topling_zip_boost_version_hpp}")
        endif()
    endif()
...
if(USE_TOPLINGDB)
    ...
    set(CMAKE_INSTALL_RPATH "${TOPLINGDB_ROOT}")
endif()
